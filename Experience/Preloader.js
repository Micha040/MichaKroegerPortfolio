...
export default class Preloader extends EventEmitter{
    ...
    firstIntro(){
            return new Promise((resolve)=>{
                ...
                this.timeline.to(this.roomChildren.cubetest.scale, {
                    x: 1.4,
                    y: 1.4,
                    z: 1.4,
                    ease: "back.out(2.5)",
            ...
            this.timeline.to(".intro-text .animatedis", {
                ...
                opacity: 1,
            },"remove_arrow_header").to(".toggle-bar", {
                opacity: 1,
                onComplete: resolve,
            },"remove_arrow_header");
        });
    ...
    secondIntro(){
        ...
        this.secondTimeline.to(".intro-text .animatedis", {
            ...
            z: 0,
            duration: 0.5,
        }, "same").to(this.roomChildren.cubetest.rotation,{
            y: 2*Math.PI + Math.PI/4
        }, "same").to(this.roomChildren.cubetest.scale,{
            x: 11.5,
            y: 11.5,
            z: 11.5,
            duration: 0.5,
            ...
            y: 3.5,
            duration: 0.5,
        }, "same").to(this.roomChildren.cubetest.position,{
            x: 1.22397 ,
            y: 6.48117,
            z: 0.448537 ,
            duration: 0.5,
            ...
            y: 1,
            z: 1,
        }).to(this.roomChildren.cubetest.scale, {
            x: 0,
            y: 0,
            z: 0, 
            duration: 1.2,
        }, "text").to(".hero-main-title .animatedis", {
            yPercent: 0,
            stagger: 0.07,
            ease: "backout(1.2)",
